...
class BaseLLMProvider(ABC):
    ...
    def structured_streaming_output(
        ...
        **kwargs
        ...
        """
        Stream validated Pydantic objects.
        ...
        # Pass response to parser_integration module and yield validated Pydantic objects
        for result in parse_streaming_response(response, output_schema):
            # Only yield if there's actual data (not the final usage/finished message)
